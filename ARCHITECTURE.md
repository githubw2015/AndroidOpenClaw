# AndroidOpenClaw 架构文档

## 📁 项目数据目录

```
/sdcard/AndroidOpenClaw/              ← 项目数据根目录 (对齐 OpenClaw ~/.openclaw/)
├── config/
│   └── openclaw.json                 ← 主配置文件
├── workspace/
│   ├── .androidopenclaw/
...
1. **工作区 Skills** (最高) — `/sdcard/AndroidOpenClaw/workspace/skills/`
2. **托管 Skills** (中等) — `/sdcard/AndroidOpenClaw/skills/` (ClawHub 安装)
...
**主配置文件**: `/sdcard/AndroidOpenClaw/config/openclaw.json`
...
- [MAPPING.md](MAPPING.md) — OpenClaw ↔ AndroidOpenClaw 源码映射
