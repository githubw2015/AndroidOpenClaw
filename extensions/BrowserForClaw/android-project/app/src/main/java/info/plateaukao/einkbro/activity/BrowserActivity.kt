...
open class BrowserActivity : FragmentActivity(), BrowserController {
    ...
    // Public getter for external access (e.g., browserforclaw integration)
    fun getCurrentAlbumController(): AlbumController? = currentAlbumController
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Register to browserforclaw BrowserManager
        com.forclaw.browser.control.manager.BrowserManager.setBrowserActivity(this)
...
//                "NoCoin Filter List" to "https://filters.adtidy.org/extension/chromium/filters/242.txt"
    ...
    override fun onDestroy() {
        // Unregister from browserforclaw BrowserManager
        com.forclaw.browser.control.manager.BrowserManager.setBrowserActivity(null)
