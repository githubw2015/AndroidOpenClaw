...
import com.xiaolongxia.androidopenclaw.accessibility.databinding.ActivityObserverPermissionsBinding
...
class PermissionActivity : Activity() {
    ...
    override fun onResume() {
        ...
        sendBroadcast(android.content.Intent("com.xiaolongxia.androidopenclaw.PERMISSION_CHANGED"))
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        return try {
            ...
            val serviceFull = "${packageName}/com.xiaolongxia.androidopenclaw.accessibility.service.PhoneAccessibilityService"
