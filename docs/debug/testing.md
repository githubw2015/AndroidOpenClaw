...
```bash
adb shell am broadcast -a PHONE_FORCLAW_SEND_MESSAGE --es message "打开微信" com.xiaolongxia.androidopenclaw
```
...
# 检查模型配置
adb shell cat /sdcard/AndroidOpenClaw/config/openclaw.json | head -20
```
