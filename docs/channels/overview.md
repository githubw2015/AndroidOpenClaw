...
adb shell am broadcast \
  -a com.xiaolongxia.androidopenclaw.ACTION_EXECUTE_AGENT \
  -p com.xiaolongxia.androidopenclaw.debug \
  --es message "你的消息"
```
...
**代码**: `app/src/main/java/com/xiaomo/androidopenclaw/core/AgentMessageReceiver.kt`

**测试**:
```bash
adb shell am broadcast -a PHONE_FORCLAW_SEND_MESSAGE --es message "测试" com.xiaolongxia.androidopenclaw
```
