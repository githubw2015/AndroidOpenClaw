...
[![Release](https://img.shields.io/badge/Release-v1.3.0-blue.svg)](https://github.com/SelectXn00b/AndroidOpenClaw/releases/latest)
...
> 这不是 AndroidOpenClaw 自身使用的——是给 Claude Desktop、Cursor 等外部 Agent 调用的。
...
> Skills 存储在 `/sdcard/AndroidOpenClaw/skills/`，可自由编辑、添加、删除。
...
```bash
git clone https://github.com/githubw2015/AndroidOpenClaw.git
cd AndroidOpenClaw
export JAVA_HOME=/path/to/jdk17
./gradlew assembleRelease
adb install releases/AndroidOpenClaw-v1.3.0-release.apk
```
