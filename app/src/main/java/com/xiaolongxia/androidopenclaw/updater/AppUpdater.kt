 ...
 *
 * GitHub Release URL: https://github.com/SelectXn00b/AndroidOpenClaw/releases
 * API: https://api.github.com/repos/SelectXn00b/AndroidOpenClaw/releases/latest
 */
class AppUpdater(private val context: Context) {
    ...
    companion object {
        ...
        const val GITHUB_REPO = "AndroidOpenClaw"
        ...
        const val APK_NAME_PREFIX = "AndroidOpenClaw"
    ...
    suspend fun checkForUpdate(): UpdateInfo = withContext(Dispatchers.IO) {
        try {
            ...
            val request = Request.Builder()
                ...
                .header("User-Agent", "AndroidOpenClaw/$currentVersion")
                .build()
    ...
    suspend fun downloadAndInstall(downloadUrl: String, version: String): Boolean = withContext(Dispatchers.IO) {
        try {
            ...
            val request = DownloadManager.Request(Uri.parse(downloadUrl)).apply {
                setTitle("AndroidOpenClaw v$version")
