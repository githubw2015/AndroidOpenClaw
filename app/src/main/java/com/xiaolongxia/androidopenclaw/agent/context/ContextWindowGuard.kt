 ...
 *
 * AndroidOpenClaw adaptation: context budget guard + context window token resolution.
 */
...
object ContextWindowGuard {
    ...
    fun resolveContextWindowInfo(
        ...
        // Note: OpenClaw has this config field; AndroidOpenClaw doesn't yet — placeholder for future
