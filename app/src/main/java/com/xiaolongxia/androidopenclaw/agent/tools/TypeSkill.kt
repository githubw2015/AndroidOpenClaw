...
class TypeSkill(private val context: Context) : Skill {
    ...
    override val description: String
        get() {
            val isAccessibilityEnabled = com.xiaolongxia.androidopenclaw.accessibility.AccessibilityProxy.isConnected.value == true &&
                                        com.xiaolongxia.androidopenclaw.accessibility.AccessibilityProxy.isServiceReady()
