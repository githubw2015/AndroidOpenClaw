package com.xiaolongxia.androidopenclaw.agent.session

/**
 * OpenClaw Source Reference:
 * - ../openclaw/src/agents/session-dirs.ts, command/session-store.ts
 *
 * AndroidOpenClaw adaptation: persist and restore agent sessions on Android.
 */


import com.xiaolongxia.androidopenclaw.logging.Log
import com.xiaolongxia.androidopenclaw.agent.memory.ContextCompressor
import com.xiaolongxia.androidopenclaw.agent.memory.TokenEstimator
import com.xiaolongxia.androidopenclaw.providers.LegacyMessage
import com.xiaolongxia.androidopenclaw.providers.LegacyToolCall
import com.xiaolongxia.androidopenclaw.providers.LegacyFunction
