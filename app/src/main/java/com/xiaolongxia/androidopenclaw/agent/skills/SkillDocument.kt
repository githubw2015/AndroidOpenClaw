...
data class SkillDocument(
     ...
     * "managed" - From /sdcard/AndroidOpenClaw/skills/ (aligns with ~/.openclaw/skills/)
     * "workspace" - From /sdcard/AndroidOpenClaw/workspace/skills/ (aligns with ~/.openclaw/workspace/)
...
enum class SkillSource(val displayName: String) {
    ...
    MANAGED("managed"),      // /sdcard/AndroidOpenClaw/skills/ (aligns with ~/.openclaw/skills/)
    WORKSPACE("workspace"),  // /sdcard/AndroidOpenClaw/workspace/skills/ (aligns with ~/.openclaw/workspace/)
