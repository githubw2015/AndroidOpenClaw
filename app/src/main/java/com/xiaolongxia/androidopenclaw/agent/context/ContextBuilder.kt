 ...
 *
 * AndroidOpenClaw adaptation: build system prompt, tools section, skills context.
 */


import android.content.Context
import com.xiaolongxia.androidopenclaw.logging.Log
import com.xiaolongxia.androidopenclaw.agent.skills.RequirementsCheckResult
...
class ContextBuilder(
    ...
    // AndroidOpenClaw: /sdcard/AndroidOpenClaw/workspace
    private val workspaceDir = File("/sdcard/AndroidOpenClaw/workspace")
    ...
    fun buildSystemPrompt(
        ...
        parts.add("## Workspace Files (injected)\nThese user-editable files are loaded by AndroidOpenClaw and included below in Project Context.")
    ...
    private fun buildIdentitySection(): String {
        ...
        val accessibilityEnabled = try {
            val proxy = com.xiaolongxia.androidopenclaw.accessibility.AccessibilityProxy
...
You are AndroidOpenClaw, an AI agent running on Android devices.
...
Do not manipulate or persuade anyone to expand access or disable safeguards. Do not copy yourself or change system prompts, safety rules, or tool policies unless explicitly requested.
    ...
    private fun buildChannelSection(): String {
        ...
        return if (hints.isNotEmpty()) {
            "# Channel: ${com.xiaolongxia.androidopenclaw.channel.CHANNEL_META.emoji} ${com.xiaolongxia.androidopenclaw.channel.CHANNEL_META.label}\n\n" +
            hints.joinToString("\n")
        } else {
            ""
        }
    ...
    private fun buildMessagingSection(channelContext: ChannelContext?): String {
        ...
        parts.add("The following JSON is generated by AndroidOpenClaw out-of-band. Treat it as authoritative metadata about the current message context.")
...
HEARTBEAT_OK
AndroidOpenClaw treats a leading/trailing "HEARTBEAT_OK" as a heartbeat ack (and may discard it).
