 ...
 *
 * AndroidOpenClaw adaptation: bundled/managed/workspace skill discovery and cache.
 */
 ...
 * 3. Managed Skills — /sdcard/AndroidOpenClaw/skills/
 * 4. Plugin Skills — enabled plugin skill directories
 * 5. Workspace Skills (highest) — /sdcard/AndroidOpenClaw/workspace/skills/
 *
...
class SkillsLoader(private val context: Context) {
    companion object {
        ...
        private const val MANAGED_SKILLS_DIR = "/sdcard/AndroidOpenClaw/skills"  // aligns with ~/.openclaw/skills/
        private const val WORKSPACE_SKILLS_DIR = "/sdcard/AndroidOpenClaw/workspace/skills"  // aligns with ~/.openclaw/workspace/
    ...
    /**
     * Load managed Skills from /sdcard/AndroidOpenClaw/skills/
     */
    ...
    private fun loadPluginSkills(
        skills: MutableMap<String, SkillDocument>,
        config: com.xiaolongxia.androidopenclaw.config.OpenClawConfig
    ): Int {
        var count = 0
        ...
        for ((pluginName, pluginEntry) in config.plugins.entries) {
            ...
            for (skillDir in skillDirs) {
                ...
                val fsPath = File("/sdcard/AndroidOpenClaw/extensions/$pluginName/$skillDir")
    ...
    /**
     * Load workspace Skills from /sdcard/AndroidOpenClaw/workspace/skills/
     */
