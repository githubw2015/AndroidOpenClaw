...
import com.xiaolongxia.androidopenclaw.agent.skills.*
import com.xiaolongxia.androidopenclaw.config.ConfigLoader
import com.xiaolongxia.androidopenclaw.gateway.protocol.GatewayError
...
class SkillsMethods(private val context: Context) {
    ...
    fun update(params: JsonObject): Result<JsonObject> {
        return try {
            ...
            val existingConfig = config.skills.entries[skillKey] ?: com.xiaolongxia.androidopenclaw.config.SkillConfig()
