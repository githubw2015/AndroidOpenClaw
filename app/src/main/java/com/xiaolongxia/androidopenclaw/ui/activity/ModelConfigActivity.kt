...
import com.xiaolongxia.androidopenclaw.databinding.ActivityModelConfigBinding
import com.google.android.material.card.MaterialCardView
import com.google.android.material.textfield.TextInputEditText
import com.google.android.material.textfield.TextInputLayout
import com.xiaolongxia.androidopenclaw.config.*
...
class ModelConfigActivity : AppCompatActivity() {
    ...
    private fun setupPage2(provider: ProviderDefinition) {
        ...
        var savedModels: List<com.xiaolongxia.androidopenclaw.config.ModelDefinition>? = null
        try {
            val config = configLoader.loadOpenClawConfig()
            val existingProvider = config.resolveProviders()[provider.id]
            if (existingProvider != null) {
