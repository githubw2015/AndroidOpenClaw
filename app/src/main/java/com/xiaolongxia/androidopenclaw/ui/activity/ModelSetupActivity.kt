...
import com.xiaolongxia.androidopenclaw.databinding.ActivityModelSetupBinding
import com.xiaolongxia.androidopenclaw.config.ConfigLoader
import com.xiaolongxia.androidopenclaw.config.ModelDefinition
import com.xiaolongxia.androidopenclaw.config.ModelsConfig
...
class ModelSetupActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun isNeeded(context: android.content.Context): Boolean {
            val configFile = java.io.File("/sdcard/AndroidOpenClaw/openclaw.json")
    ...
    private fun saveAndFinish() {
        ...
        val apiKey = if (userInputKey.isNullOrEmpty()) {
            val builtInKey = com.xiaolongxia.androidopenclaw.config.BuiltInKeyProvider.getKey()
        ...
        try {
            ...
            val modelSelection = com.xiaolongxia.androidopenclaw.config.ModelSelectionConfig(primary = defaultModelId)
            val existingAgents = config.agents ?: com.xiaolongxia.androidopenclaw.config.AgentsConfig()
