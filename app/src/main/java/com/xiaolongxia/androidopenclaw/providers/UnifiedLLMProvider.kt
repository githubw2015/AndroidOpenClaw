 ...
 *
 * AndroidOpenClaw adaptation: unified provider dispatch for Android (non-streaming batch calls).
 */
...
import com.xiaolongxia.androidopenclaw.providers.llm.FunctionDefinition as NewFunctionDefinition
import com.xiaolongxia.androidopenclaw.providers.llm.ParametersSchema as NewParametersSchema
import com.xiaolongxia.androidopenclaw.providers.llm.PropertySchema as NewPropertySchema
...
class UnifiedLLMProvider(private val context: Context) {
        ...
        .addNetworkInterceptor { chain ->
            chain.proceed(
                chain.request().newBuilder()
                    .header("User-Agent", "AndroidOpenClaw/${com.xiaolongxia.androidopenclaw.BuildConfig.VERSION_NAME}")
                    .build()
            )
        }
        .build()
    ...
    private suspend fun performRequest(
        messages: List<Message>,
        tools: List<com.xiaolongxia.androidopenclaw.providers.llm.ToolDefinition>?,
        modelRef: String?,
        temperature: Double,
        maxTokens: Int?,
